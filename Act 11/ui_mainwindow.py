...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.Dibujar, 2, 0, 1, 1)

        self.limpiar = QPushButton(self.tab)
        self.limpiar.setObjectName(u"limpiar")

        self.gridLayout_4.addWidget(self.limpiar, 2, 1, 1, 1)
        ...
        self.cercas = QPushButton(self.tab)
        self.cercas.setObjectName(u"cercas")

        self.gridLayout_4.addWidget(self.cercas, 1, 0, 1, 1)

        self.puntos = QPushButton(self.tab)
        self.puntos.setObjectName(u"puntos")

        self.gridLayout_4.addWidget(self.puntos, 1, 1, 1, 1)
        ...
        self.grafica.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cercas.setText(QCoreApplication.translate("MainWindow", u"Puntos mas cercanos", None))
        self.puntos.setText(QCoreApplication.translate("MainWindow", u"Generar puntos", None))
